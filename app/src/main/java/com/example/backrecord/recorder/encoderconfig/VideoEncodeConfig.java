...
import com.example.backrecord.recorder.encode_utils.Utils;
...
public final class VideoEncodeConfig implements Parcelable {
    public static final int DEFAULT_VIDEO_BITRATE = 15000000;
    public static final float DEFAULT_VIDEO_MULTIPLE = 1.0f;
    ...
    public /* synthetic */ VideoEncodeConfig(String str, String str2, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, Integer num, Integer num2, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, str2, i, i2, i3, i4, i5, i6, i7, i8, (i9 & 1024) != 0 ? null : num, (i9 & 2048) != 0 ? null : num2);
    }
    ...
    public static final class Companion {
        ...
        public final VideoEncodeConfig readFromPrefs(Context context, int i) {
            ...
            if (configPreferences.contains(VideoEncodeConfig.KEY_VIDEO_HEIGHT)) {
                ...
                //获取屏幕的宽、高，单位是像素
                int width = (int) (windowManager.getMaximumWindowMetrics().getBounds().width()/DEFAULT_VIDEO_MULTIPLE);
                int height = (int) (windowManager.getMaximumWindowMetrics().getBounds().height()/DEFAULT_VIDEO_MULTIPLE);
