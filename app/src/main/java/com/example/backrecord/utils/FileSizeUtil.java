...
public class FileSizeUtil {
     ...
     *
     * @param filePath 文件路径
     * @param SIZE_TYPe 获取大小的类型1为B、2为KB、3为MB、4为GB
     * @return double值的大小
     */
    public static double getFileOrFilesSize(String filePath, int SIZE_TYPe) {
        ...
        return FormatFileSize(blockSize, SIZE_TYPe);
    }
     ...
     * @return
     */
    private static double FormatFileSize(long fileS, int SIZE_TYPe) {
        DecimalFormat df = new DecimalFormat("#.00");
