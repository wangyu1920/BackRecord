...
import com.example.backrecord.recorder.utils.DbHelper;
import com.example.backrecord.recorder.utils.RecordPath;
...
public class CaptureScreenService extends Service {
    ...
    protected ScreenRecorder getScreenRecorder() {
        ...
        RecordPath recordPath = new RecordPath(this, DbHelper.createFileUri(context,VirtualDisplayName,videoEncodeConfig,"video/mp4"));
        ScreenRecorder recorder =new ScreenRecorder(videoEncodeConfig, getDefaultAudioEncodeConfig(), recordPath,virtualDisplay);
        recorder.setCallback(new ScreenRecorder.Callback() {
            ...
            public void onStop(Throwable th) {
                Log.d(TAG, "onStop: ");
                DbHelper.deletePendingOne(context);
            }
        });
        return recorder;
    }
    ...
    protected RecordPath getRecordPath() {
        recordPath = new RecordPath(this, DbHelper.createFileUri(this, VirtualDisplayName, videoEncodeConfig, "video/mp4"));
        return recordPath;
    }
     ...
     * 如果SharedPreferences中没有保存参数，则视频长宽使用设备屏幕长宽/1.5(720p)
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_CANCEL:
                        ...
                        if (((System.currentTimeMillis()-add[1])<100)&&(add[0]<30)) {
